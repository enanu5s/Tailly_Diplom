    ...
    <main className={styles.page}>
      ...
      <section className={styles.card}>
        <div className={styles.left}>
          ...
          <h1 className={styles.title}>Упс, похоже, мы потеряли след этой страницы</h1>

          <p className={styles.description}>{randomMessage}</p>
          ...
          <div className={styles.actions}>
            ...
            <button type="button" className={styles.ghostButton} onClick={handleGoBack}>
              Назад
            </button>
          </div>
