...
export const FeedbackSection = ({
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(e?.message ?? 'Не удалось отправить вопрос');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.left}>
            ...
            <div className={styles.imageWrap} aria-hidden="true">
              ...
              {imageSrc ? <img className={styles.image} src="/images/Picture_bg_3.png" alt={imageAlt} /> : null}
            </div>
          </div>
          ...
          <div className={styles.right}>
            <div className={styles.card}>
              ...
              <form className={styles.form} onSubmit={onSubmit}>
                ...
                {success && <div className={styles.success}>Вопрос отправлен! Мы скоро ответим.</div>}
