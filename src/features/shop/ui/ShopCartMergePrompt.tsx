    ...
    <div className={styles.overlay}>
      <div className={styles.modal} role="dialog" aria-modal="true">
        ...
        <p className={styles.text}>
          После входа мы нашли товары в гостевой корзине и в корзине вашего
          аккаунта.
        </p>
        ...
        <div className={styles.stats}>
          <div className={styles.statCard}>
            ...
            <span className={styles.statValue}>
              {prompt.guestItemsCount} шт.
            </span>
            <span className={styles.statMeta}>
              {prompt.guestLinesCount} поз.
            </span>
          </div>
          ...
          <div className={styles.statCard}>
            ...
            <span className={styles.statValue}>
              {prompt.userItemsCount} шт.
            </span>
            <span className={styles.statMeta}>
              {prompt.userLinesCount} поз.
            </span>
          </div>
        </div>

        <p className={styles.note}>
          Если нажать “Объединить корзины”, товары будут объединены.
          Если нажать “Отмена”, останется только корзина аккаунта, а гостевая
          корзина будет удалена.
        </p>
