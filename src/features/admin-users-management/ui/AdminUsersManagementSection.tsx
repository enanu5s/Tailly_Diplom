...
function getFullName(
  ...
  const value = [lastName, firstName, middleName]
    .filter(Boolean)
    .join(' ')
    .trim();
...
export const AdminUsersManagementSection = observer(
  (): ReactElement => {
          ...
          <div className={styles.filtersGrid}>
            ...
            <label className={styles.field}>
              ...
              <select
                ...
                onChange={(event) =>
                  store.setRoleFilter(
                    event.target.value as 'all' | 'client' | 'specialist',
                  )
                }
              >
              ...
              <div className={styles.formGrid}>
                <label className={styles.field}>
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      store.setBlockReason(event.target.value)
                    }
                ...
                <label className={styles.checkboxRow}>
                  <input
                    ...
                    onChange={(event) =>
                      store.setPermanentBlock(event.target.checked)
                    }
                  />
                ...
                <>
                  ...
                  <label className={styles.field}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        store.setBlockedUntil(event.target.value)
                      }
                    />
                  </label>
                </>
