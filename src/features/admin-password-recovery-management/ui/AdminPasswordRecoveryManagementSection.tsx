...
export const AdminPasswordRecoveryManagementSection = observer(
  (): ReactElement => {
    ...
    return (
      <div className={styles.root}>
        <div className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>
              Здесь отображаются заявки на восстановление пароля для
              администраторов и главного администратора. После обработки
              генерируется временный пароль и обновляется mock-аккаунт
              администратора.
            </p>
          </div>
        </div>
        ...
        {copyError ? (
          <div className={styles.errorBanner}>{copyError}</div>
        ) : null}
          ...
          <div className={styles.content}>
            ...
            <section className={styles.section}>
              <div className={styles.sectionHeader}>
                ...
                <span className={styles.counter}>
                  {store.processedRequests.length}
                </span>
              </div>
