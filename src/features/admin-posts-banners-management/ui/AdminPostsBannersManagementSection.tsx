...
export const AdminPostsBannersManagementSection = observer(
  (): ReactElement => {
                  ...
                  <article key={banner.id} className={styles.card}>
                    <div className={styles.cardHeader}>
                      ...
                      <div className={styles.cardActions}>
                        ...
                        >
                          {store.deletingBannerId === banner.id
                            ? 'Удаление...'
                            : 'Удалить'}
                        </button>
                      </div>
                    ...
                    <dl className={styles.detailsGrid}>
                      <div>
                        <dt>Куда ведёт</dt>
                        <dd>{getBannerLinkTargetLabel(banner.linkTarget)}</dd>
                      </div>
                      <div>
                        <dt>Период показа</dt>
                        <dd>
              ...
              <aside className={styles.editorPanel}>
                ...
                <label className={styles.field}>
                  ...
                  >
                    ...
                    <option value="posts">Раздел постов</option>
