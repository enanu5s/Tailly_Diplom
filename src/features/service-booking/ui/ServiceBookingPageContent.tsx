                ...
                <div className={styles.fieldWide}>
                  ...
                  {availableDates.length === 0 ? (
                    <div className={styles.emptyState}>
                      У выбранного специалиста пока нет доступных слотов для этой
                      услуги.
                    </div>
            ...
            {bookingMode === 'time_range' ? (
              <div className={styles.fieldWide}>
                ...
                <div className={styles.infoBox}>
                  ...
                  доступного окна специалиста. Проверка пересечений и ограничений
                  выполняется при создании заказа.
                </div>
              </div>
            ) : null}
