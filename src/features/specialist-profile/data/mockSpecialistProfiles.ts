  ...
  reviews: [
    {
      ...
      photos: [
        '/images/specialist-profile/review-cat.png',
        '/images/specialists/pets/pet-2.jpg',
        '/images/specialists/pets/pet-3.jpg',
      ],
      specialistReply: {
    ...
    },
    {
      ...
      photos: [
        '/images/specialist-profile/review-rabbit.png',
        '/images/specialists/pets/pet-4.jpg',
      ],
    },
    {
