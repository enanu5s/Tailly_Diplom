...
type Props = {
  reviewedBy: string;
  onCreated: (result: { specialistId: string; specialistSlug?: string }) => void;
};
      ...
      <div className={styles.overlay}>
        <div className={styles.modal}>
          <div className={styles.header}>
            <div>
              <h2 className={styles.title}>Создание кабинета специалиста</h2>
              <p className={styles.subtitle}>
                Проверь данные из анкеты и создай специалисту аккаунт. После создания
                отправь ему временный пароль по email.
              </p>
            </div>
          ...
          <div className={styles.grid}>
            ...
            <label className={styles.fieldWide}>
              ...
              <textarea
                ...
                onChange={(event) => store.setFormField('about', event.target.value)}
              />
            </label>
          </div>
          ...
          <label className={styles.checkboxRow}>
            ...
            />
            <span>
              Подтверждаю создание кабинета специалиста и обработку персональных данных.
            </span>
          </label>
          ...
          <div className={styles.actions}>
            ...
            <button
              ...
              onClick={async () => {
                const result = await store.createSpecialistAccount(reviewedBy);
            ...
            >
              {store.isCreating ? 'Создаём...' : 'Создать кабинет'}
            </button>
          </div>
        </div>
      </div>
